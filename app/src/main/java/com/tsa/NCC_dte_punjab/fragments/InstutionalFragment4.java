...
public class InstutionalFragment4 extends Fragment {
    private View view;
    private WebView webView;
    private String urls[]=new String[]{"https://docs.google.com/viewerng/viewer?url=http://nccindia.nic.in/sites/default/files/ANO+Hand+Book_1.pdf",""};
