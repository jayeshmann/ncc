...
public class UnityCornerFragment1 extends Fragment {
    private View view;
    private WebView webView;
    private String urls[]=new String[]{"http://nccindia.nic.in/sites/default/files/NCC+ACT+and+Rules++Dec+1948.pdf",""};
